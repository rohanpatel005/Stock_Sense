    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0 bg-slate-900/60 backdrop-blur-sm sm:items-end">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto">
          ...
          {success && (
            <div className="mb-6 bg-emerald-50 border border-emerald-100 text-emerald-700 p-4 rounded-xl flex items-start gap-3 text-sm font-bold shadow-sm">
          ...
          <div className="flex items-center gap-3">
            {!showConfirm ? (
              <button 
                ...
                form="trade-form"
                disabled={loading}
                className={`flex-1 py-4 rounded-xl text-white font-black text-sm uppercase tracking-wide flex items-center justify-center gap-2 transition-all shadow-lg ${
                  isBuy 
